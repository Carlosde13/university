...
include("../controller/traer-misAlumnos.php");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="">
        <div class="w-full h-screen flex justify-start">
            ...
            <div class="w-10/12 h-screen bg-[#f5f6fa] parte-blanca-login">
                ...
                <h1 class="text-[28px] font-semibold p-[10px]">Mis Alumnos</h1>
                <div class="w-11/12 h-auto bg-white m-[10px]">
                    ...
                    <div class="w-full h-[50px] flex flex-row justify-start items-center p-[10px] border-solid border-gray-400">
                        <div class="w-1/2 flex justify-start items-start">
                            <p>Informacion de Mis Alumnos</p>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50 ">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Nombre del Alumno</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class='px-6 py-4 whitespace-nowrap'><?php echo $e['nombre_clase']; ?></td>
